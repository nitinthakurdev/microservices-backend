import { sequlizedConnection } from '@auth/database';
import { IAuthDocument } from '@nitinthakurdev/jobber-package';
...
const AuthModel: ModelDefined<IAuthDocument, AuthUserCreationAttributes> & AuthModelInstanceMethods = sequlizedConnection.define('auths', {
  username: {
